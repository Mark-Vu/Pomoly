...
from server.models import VerificationCode, db
...
def test_user_registration(client):
    ...
    client.post('/users/auth/register', json={'email': email})
    ...
    response = client.post('/users/auth/register', json=registration_data)
    assert response.status_code == 200
    assert b'ok' in response.data

    print(f"\nSuccess: Test resgister complete")
    print("================================================================================")
